...
void World::Update(uint32 diff, uint32 operationalWallDiff)
{
...

    {
        ...
        // Keep admission and packet IO live on every stock-sized
        // simulation step. A zero wall diff polls sessions without
        // advancing disconnected-session expiry again.
